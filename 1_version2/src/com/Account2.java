...
public class Account2 extends Account1 implements Serializable {
    ...
    public Account2(double balance,String name ,String password,double annualInterestRate) throws balanceException , idException {
        double id = Math.random() * 100;
        new Account1((int)id,balance,annualInterestRate);
